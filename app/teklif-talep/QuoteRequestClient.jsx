          ...
          <section className="rounded-[28px] bg-white p-5 shadow-[0_24px_60px_rgba(15,35,35,0.08)] md:p-7">
            <div className="mb-6">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-600">
                Miktarları net yaz. Fiyat, termin ve teslim bilgisi satış ekibi
                tarafından teklif üzerinde dönecek.
              </p>
            </div>
            ...
            {loading ? (
              ...
              <div className="rounded-3xl bg-slate-50 p-8 text-center">
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Ürün kartından veya ürün detayından teklif listesine ekleme yap.
                </p>
              </div>
            ) : (
            ...
            <section className="rounded-[28px] bg-white p-5 shadow-[0_24px_60px_rgba(15,35,35,0.08)] md:p-7">
              ...
              <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
                ...
                <Field
                  icon={<MapPin size={16} />}
                  label="Teslim şehri"
                  name="requestedDeliveryCity"
                  value={form.requestedDeliveryCity}
                  onChange={handleChange}
                />
                <Field
                  label="İstenen termin (gün)"
                  name="requestedTermDays"
                  type="number"
                  value={form.requestedTermDays}
                  onChange={handleChange}
                />

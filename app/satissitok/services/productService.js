...
function normalizeAdminProductRecord(id, raw = {}) {
  ...
  return {
    ...
    highlightLines: toStr(raw.highlightLines),
    ...
    packQty: raw.packQty === "" ? "" : raw.packQty ?? "",
    caseQty: raw.caseQty === "" ? "" : raw.caseQty ?? "",
...
export function normalizeProductInput(raw) {
  ...
  const product = {
    ...
    fuelType: toStr(raw.fuelType),
    material: toStr(raw.material),
    packQty: raw.packQty === "" ? null : raw.packQty ?? null,
    caseQty: raw.caseQty === "" ? null : raw.caseQty ?? null,
    unitType: toStr(raw.unitType),
    power: toStr(raw.power),
    voltage: toStr(raw.voltage),
    warranty: toStr(raw.warranty),

...
export default function PurchaseItemsTable({
  ...
  return (
    <div className="overflow-hidden rounded-[24px] border border-slate-200 bg-white">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 bg-slate-50/70 px-4 py-3.5">
        <div className="flex items-center gap-2 text-slate-900">
          ...
          <div>
            ...
            <h2 className="text-sm font-semibold text-slate-900">Satır Öğeleri</h2>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={addRow}
            disabled={disabled}
            className="flex items-center gap-2 rounded-xl bg-slate-950 px-3 py-2 text-xs font-semibold text-white transition-all hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <Plus size={16} />
            Satır Ekle
          </button>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-50 text-[11px] font-bold uppercase tracking-wider text-slate-500">
              ...
              <th className="min-w-[300px] px-4 py-3">Ürün / SKU</th>
              <th className="w-24 px-4 py-3">Miktar</th>
              <th className="w-24 px-4 py-3">Birim</th>
              <th className="w-44 px-4 py-3 text-right">Birim Maliyet (₸)</th>
              <th className="w-24 px-4 py-3 text-right">KDV %</th>
              <th className="w-44 px-4 py-3 text-right">Toplam (₸)</th>
          ...
          <tbody className="divide-y divide-slate-100">
            {items.map((row, i) => (
              ...
              >
                ...
                <td className="px-4 py-3.5">
                  <input
                    className="w-full rounded-xl border border-slate-200 bg-white px-2 py-2 text-center text-sm focus:border-[#135bec] focus:ring-0"
                    type="number"
                    min={0}
                    step="0.01"
                    value={row.qty}
                ...
                <td className="px-4 py-3.5">
                  <div className="flex flex-col items-end gap-1">
                    <input
                      className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-right font-mono text-sm font-semibold focus:ring-0"
                      type="number"
                      min={0}
                      step="0.01"
                      value={row.unitPrice}
              ...
              <td className="px-4 py-3.5" colSpan={8}>
                <div className="flex items-center gap-4 w-full">
                  <div className="flex-grow relative">
                    ...
                    <input
                      className="w-full rounded-xl border border-dashed border-slate-300 bg-white py-2.5 pl-9 pr-4 text-xs font-medium focus:border-[#135bec] focus:ring-[#135bec]"

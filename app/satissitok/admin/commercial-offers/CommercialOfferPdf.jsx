...
const styles = StyleSheet.create({
  ...
  titleLine: { marginTop: 4, fontSize: 13.5, fontWeight: 700, color: colors.primary, textAlign: "center" },
  ...
  partyRole: { marginBottom: 4, fontSize: 12, fontWeight: 700 },
  bodyText: { fontSize: 9, lineHeight: 1.25 },
  intro: { marginTop: 14 },
  introGreeting: { fontSize: 9.5 },
  introText: { marginTop: 2, fontSize: 9.5, lineHeight: 1.3 },
  table: { marginTop: 14 },
  ...
  cell: { padding: 5, justifyContent: "center", borderRightWidth: 0.8, borderRightColor: colors.border },
  ...
  productImage: { width: 70, height: 58, objectFit: "contain" },
  imagePlaceholder: { width: 70, height: 58, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panelSoft },
  placeholderText: { fontSize: 8, color: colors.placeholder },
  productName: { fontSize: 10.5, lineHeight: 1.2, fontWeight: 700, color: colors.primary },
  sku: { marginTop: 2, marginBottom: 3, fontSize: 8, color: colors.muted },
  ...
  termTitle: { paddingHorizontal: 10, paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: colors.border, backgroundColor: colors.panelSoft, fontSize: 11.5, fontWeight: 700, color: colors.primary },
  termBody: { padding: 10 },
  termLine: { marginBottom: 4, fontSize: 9, lineHeight: 1.3 },
